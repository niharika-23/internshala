...
def embed_sentences(data, word2vec_limit=50000, num_words=20000):
    ...
    Params:
        ...
        word2vec_limit   - int: number of words used in the word embedding provided by Google - ex: 50000 num_words   
             - int: The maximum number of words to keep, based on word frequency. Only the most common num_words 
             words will be kept. - ex: 20000 
    ...
    embedding_model = gensim.models.KeyedVectors.load_word2vec_format('../word2vec/GoogleNews-vectors-negative300.bin',
                                                                      binary=True, limit=word2vec_limit)
    ...
    # Tokenize the sentences, that is to say convert the 2 sentences ["It's the first sentence!","It is the second 
    # sentence"] to 2 sequences [[1 4 2 5 3],[1 6 2 7 3]] It handles the ennoying cases (punctuation, Upper cases, 
    # etc...) 
    ...
    # Produce a dictionnary mapping words to tokens e.g. {'it': 1, 'the': 2, 'sentence': 3, 's': 4, 'first': 5, 
    # 'is': 6, 'second': 7} 
